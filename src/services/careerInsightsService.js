const newsApiClient = require('../utils/newsApiClient.js');
const bigqueryClient = require('../gcpclient/bigqueryClient.js');
const geminiClient = require('../vertexclient/geminiClient.js');
